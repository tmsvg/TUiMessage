...
def deemoji(sentence):
    """Replace emoji characters in a string with their unicode names
    """
    ...
    def dynamic_replace(match):
        if match:
            ...
            for i in match.group(0):
                name = unicodedata.name(i).lower()
                if name[:18] == "variation selector":
                    name = ""
                else:
                    name = ":" + name + ":"
                r.append(name)
    ...
    emoji_pattern = re.compile("["
                               ...
                               u"\U0000267B"
                               u"\U0000267F"
                               u"\U00002692-\U00002694"
                               u"\U00002696-\U00002697"
                               u"\U00002699"
                               ...
                               u"\U00002702"
                               u"\U00002705"
                               u"\U00002708-\U00002709"
                               u"\U0000270A-\U0000270B"
                               u"\U0000270C-\U0000270D"
                               u"\U0000270F"
                               u"\U00002712"
                               u"\U00002714"
                               u"\U00002716"
    ...
    return emoji_pattern.sub(dynamic_replace, sentence)


def emojify(sentence):
    """Replaces Unicode emoji names that are surrounded by colons `:` with emojis
    """
    def dynamic_replace(match):
        if match:
            try:
                name = match.group(0)
                name = name[1:][:-1]
                name = unicodedata.lookup(name.upper())
                return name
            except KeyError:
                return match.group(0)
        else:
    ...
    s = re.compile(":([\w -]+):")
    return s.sub(dynamic_replace, sentence)
